...
from eval_utils import eval_utils_cmkd
...
def parse_config():
    ...
    parser.add_argument('--pretrained_lidar_model', type=str, default=None,
                        help='pretrained_lidar_model')  # e.g. SECOND
    parser.add_argument('--max_waiting_mins', type=int, default=30, help='max waiting minutes')
    parser.add_argument('--start_epoch', type=int, default=0, help='')
    parser.add_argument('--eval_tag', type=str, default='default', help='eval tag for this experiment')
    parser.add_argument('--eval_all', action='store_true', default=False, help='whether to evaluate all checkpoints')
    parser.add_argument('--use_lidar_head', action='store_true', default=False, help='')

...
class CenterHead(nn.Module):
    ...
    def forward(self, data_dict):
        ...
        # if lidar model as teacher model, do not predict
        if (not self.training or self.predict_boxes_when_training) and (not self.as_teacher):
        ...
        # if lidar model as teacher model, just return logits, do not decode box
        if self.as_teacher:
            data_dict['teacher_pred'] = pred_dicts

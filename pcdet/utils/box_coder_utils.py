...
class ResidualCoder(object):
    ...
    def encode_torch(self, boxes, anchors):
        """
        Args:
            boxes: (N, 7 + C) [x, y, z, dx, dy, dz, heading, ...] (gt boxes)
            anchors: (N, 7 + C) [x, y, z, dx, dy, dz, heading or *[cos, sin], ...] (anchors)
    ...
    def decode_torch(self, box_encodings, anchors):
        """
        Args:
            box_encodings: (B, N, 7 + C) or (N, 7 + C) [x, y, z, dx, dy, dz, heading or *[cos, sin], ...]; (B,N,7)
            anchors: (B, N, 7 + C) or (N, 7 + C) [x, y, z, dx, dy, dz, heading, ...]; (B,N,7)
